...
public interface ObjectShortNullMap {
	...
	abstract class R<K extends Comparable<? super K>> implements Cloneable, Comparable<R<K>>, ISrc<K> {
		...
		public short value(@Positive_ONLY int contains) { return contains == Positive_Values.VALUE ? NullKeyValue : values.get(contains); }
		...
		@Override public short read_val(@Positive_ONLY int info) {return values.get(info); }
