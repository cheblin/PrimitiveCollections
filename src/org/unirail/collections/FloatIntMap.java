...
public interface FloatIntMap {
	...
	class R implements Cloneable, Comparable<R>, Producer {
		...
		public @Positive_Values int info( Float     key) { return key == null ? hasNullKey ? Positive_Values.VALUE : Positive_Values.NONE : info((float) (key + 0));}
	...
	class RW extends R implements Consumer {
		...
		@Override public boolean put( Float     key, int value) {
