...
public interface ObjectUIntMap {
	...
	class R<K extends Comparable<? super K>> implements Cloneable, Comparable<R<K>>, Producer<K> {
		...
		public long value(@Positive_ONLY int contains) {return contains == Positive_Values.VALUE ? NullKeyValue :  (0xFFFFFFFFL &  values.array[contains]); }
		...
		@Override public long produce_val(int info) {return values.value(info); }
