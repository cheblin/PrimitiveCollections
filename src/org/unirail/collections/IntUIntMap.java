...
public interface IntUIntMap {
	...
	class R implements Cloneable, Comparable<R>, Reader {
		...
		@Override public long read_val(int info) {return  (0xFFFFFFFFL &  values.array[info]); }
	...
	class RW extends R implements Writer {
		...
		@Override public boolean put( Integer   key, long value) {
		...
		@Override public boolean put(int key, long value) {
