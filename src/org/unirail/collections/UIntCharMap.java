...
public interface UIntCharMap {
	...
	class R implements Cloneable, Comparable<R> {
		...
		public @Nullable int tag(  Integer   key ) {return key == null ? hasNull ? Nullable.NULL : Nullable.NONE : tag( (long) key );}
		...
		public Producer producer() {
			return producer == null ? producer = new Producer() {
				...
				public char value( int tag ) {return assigned == 0 || tag == keys.array.length ? OValue : (char) values.array[tag]; }
