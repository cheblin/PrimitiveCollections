...
public interface ByteCharMap {
	...
	interface NonNullKeysIterator {
		...
		static char value(R src, int token) {return (char) src.values.array[ByteSet.NonNullKeysIterator.index(null, token)];}
	}
	...
	class RW extends R {
		...
		public RW(int length) {values = new CharList.RW(265 < length ? 256 : length);}
