...
public class UIntRingBuffer {
	...
	public UIntRingBuffer(int power_of_2) { buffer = new int[(int) ((mask = (1L << power_of_2) - 1) + 1)]; }
	
	public int length()                 {return buffer.length;}
	
	public int size()                   {return (int) ((write.get() - read.get()) & mask); }
	
	public long get()                   { return size() == 0 ? Long.MIN_VALUE : (0xFFFFFFFFL &  buffer[(int) (read.getAndIncrement() & mask)]); }
