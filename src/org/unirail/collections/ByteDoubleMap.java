...
public interface ByteDoubleMap {
	...
	class R implements Cloneable, Comparable<R>, Producer {
		...
		protected R(int length)                   { values = new DoubleList.RW(265 < length ? 256 : length); }
		...
		@Override public double read_val(int info) { return  values.array[info >> 8]; }
	...
	class RW extends R implements Consumer {
		...
		@Override public boolean put( Byte      key, double value) {
			if (key == null)
			{
				NullKeyValue = value;
