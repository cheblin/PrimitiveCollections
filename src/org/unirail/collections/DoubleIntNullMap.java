...
public interface DoubleIntNullMap {
	interface Consumer {
		boolean put(double key, int value);
		
		boolean put(double key,  Integer   value);
	...
	class R implements Cloneable, Comparable<R>, Producer {
		...
		@Override public double produce_key(int info) {return   keys.array[info & Integer.MAX_VALUE]; }
