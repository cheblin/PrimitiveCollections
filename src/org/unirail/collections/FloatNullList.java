...
public interface FloatNullList {
	...
	interface Reader {
		...
		float value(@Positive_ONLY int index);
	...
	class R implements Comparable<R>, Reader {
		...
		public float value( @Positive_ONLY int index) {return  values.array[nulls.rank(index) - 1]; }
	...
	class RW extends R implements Writer {
		...
		public RW( Float    ... values)         { super(values); }
