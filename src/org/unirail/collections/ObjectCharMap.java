...
public interface ObjectCharMap {
	...
	class R<K extends Comparable<? super K>> implements Cloneable, Comparable<R<K>>, Producer<K> {
		...
		public char value(@Positive_ONLY int contains) {return contains == Positive_Values.VALUE ? NullKeyValue :  (char) values.array[contains]; }
		...
		@Override public char produce_val(int state) {return values.get(state); }
