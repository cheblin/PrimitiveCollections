...
public interface ObjectCharMap {
	...
	abstract class R<K> implements Cloneable {
		...
		public char value(@Positive_ONLY int token) {return token == Positive_Values.VALUE ? NullKeyValue :  (char) values.array[token];}
