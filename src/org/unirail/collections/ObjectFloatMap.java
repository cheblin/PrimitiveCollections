...
public interface ObjectFloatMap {
	...
	class R<K extends Comparable<? super K>> implements Cloneable, Comparable<R<K>>, Producer<K> {
		...
		public float value(@Positive_ONLY int contains) {return contains == Positive_Values.VALUE ? NullKeyValue :   values.array[contains]; }
		...
		@Override public float produce_val(int state) {return values.get(state); }
