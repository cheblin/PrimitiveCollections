...
public interface IntDoubleMap {
	...
	class R implements Cloneable, Comparable<R>, Reader {
		...
		@Override public double read_val(int info) {return   values.array[info]; }
	...
	class RW extends R implements Writer {
		...
		@Override public boolean put( Integer   key, double value) {
		...
		@Override public boolean put(int key, double value) {
