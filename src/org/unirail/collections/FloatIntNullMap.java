...
public interface FloatIntNullMap {
	...
	interface Producer {
		...
		int read_val(@Positive_ONLY int info);
	...
	class R implements Cloneable, Comparable<R>, Producer {
		...
		@Override public int read_0key_val() {return OkeyValue;}
		
		@Override public float read_key(int info) {return   keys.array[info & Integer.MAX_VALUE]; }
		...
		@Override public int read_val(@Positive_ONLY int info) {return   values.value(info); }
