...
public interface DoubleShortNullMap {
	...
	public static class R implements Cloneable, Comparable<R> {
		...
		public short get( @Nullable  int tag ) { return tag == Nullable.VALUE ? OKeyValue : values.get( tag ); }
		...
		public Producer producer() {
			return producer == null ? producer = new Producer() {
				...
				public short value( int tag ) {return tag == keys.array.length ? OKeyValue :  values.get( values.tag( tag ) ) ; }
			} : producer;
		}
