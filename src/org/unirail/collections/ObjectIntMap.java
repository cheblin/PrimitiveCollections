...
public interface ObjectIntMap {
	...
	class R<K extends Comparable<? super K>> implements Cloneable, Comparable<R<K>>, Producer<K> {
		...
		public int value(@Positive_ONLY int contains) {return contains == Positive_Values.VALUE ? NullKeyValue :   values.array[contains]; }
		...
		@Override public int produce_val(int info) {return values.value(info); }
