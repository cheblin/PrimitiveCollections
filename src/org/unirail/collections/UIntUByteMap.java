...
public interface UIntUByteMap {
	...
	class R implements Cloneable, Comparable<R> {
		...
		public char get( @Nullable int tag ) {
			...
			return  (char)( 0xFFFF &  values.array[tag]);
		}
		...
		public Producer producer() {
			return producer == null ? producer = new Producer() {
				...
				public char value( int tag ) {return assigned == 0 || tag == keys.array.length ? OValue : (char)( 0xFFFF &  values.array[tag]); }
