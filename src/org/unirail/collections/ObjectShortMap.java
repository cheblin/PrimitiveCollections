...
public interface ObjectShortMap {
	...
	class R<K extends Comparable<? super K>> implements Cloneable, Comparable<R<K>>, Producer<K> {
		...
		public short value(@Positive_ONLY int contains) {return contains == Positive_Values.VALUE ? NullKeyValue :  (short) values.array[contains]; }
		...
		@Override public short read_val(int info) {return values.value(info); }
