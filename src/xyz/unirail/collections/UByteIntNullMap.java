...
public interface UByteIntNullMap {
	...
	abstract class R implements Cloneable, JsonWriter.Source {
		...
		public int value( @Positive_ONLY int token ) { return token == 256 ? NullKeyValue :    values.get( (byte) token ); }
	...
	class RW extends R implements Interface {
		...
		public boolean put( char key,  Integer   value ) {
			...
			{
				values.add1( keys.rank( (byte) key ) - 1, ( Integer  ) null );
				return true;
			}
			values.set1( keys.rank( (byte) key ) - 1, ( Integer  ) null );
