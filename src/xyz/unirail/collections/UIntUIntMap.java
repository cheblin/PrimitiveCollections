...
public interface UIntUIntMap {
	...
	interface NonNullKeysIterator {
		...
		static long value( R src, int token ) { return token == src.keys.length ? src.OKeyValue :  (0xFFFFFFFFL &  src.values[token]); }
	}
	...
	abstract class R implements Cloneable, JsonWriter.Source {
		...
		public void build( Array.ISort.Primitives.Index dst, boolean K ) {
			...
			dst.src = K ?
			          ...
			          getV == null ? getV = index -> (0xFFFFFFFFL &  values[index]) : getV;
