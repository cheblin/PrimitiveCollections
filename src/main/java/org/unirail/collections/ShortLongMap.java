	...
	class RW extends R {
		...
		private int initialize( int capacity ) {
			...
			if( flatStrategyThreshold < capacity ) {
				...
				values         = new long[ FLAT_ARRAY_SIZE ];  // 65536
		...
		private int resize( int newSize ) {
			...
			if( isFlatStrategy ) {
				...
				long[] _values = new long[ FLAT_ARRAY_SIZE ];
		 ...
		 */
		private void copy( short[] old_nexts, short[] old_keys, long[] old_values, int old_count ) {
			int new_count = 0;
