...
public class ShortRingBuffer {
	 ...
	 */
	private static final AtomicLongFieldUpdater< ShortRingBuffer > GET = AtomicLongFieldUpdater.newUpdater( ShortRingBuffer.class, "get" );
	
	/**
	 * Atomic updater for thread-safe modifications to the put pointer.
	 */
	private static final AtomicLongFieldUpdater< ShortRingBuffer > PUT = AtomicLongFieldUpdater.newUpdater( ShortRingBuffer.class, "put" );
	 ...
	 */
	public ShortRingBuffer( int capacityPowerOfTwo ) {
	 ...
	 */
	public short get_multithreaded( short defaultValueIfEmpty ) {
		long get;
		do {
	 ...
	 * @return The retrieved integer, or defaultValueIfEmpty if the buffer is empty.
	 */
	public short remove_multithreaded( short defaultValueIfEmpty ) {
		long currentGet;
		do {
	...
	public boolean put_multithreaded( short value ) {
		...
		buffer[ ( int ) currentPut & mask ] = ( short ) value;
		return true;
	}
