...
public class ByteRingBuffer {
	 ...
	 */
	private static final AtomicLongFieldUpdater< ByteRingBuffer > GET = AtomicLongFieldUpdater.newUpdater( ByteRingBuffer.class, "get" );
	
	/**
	 * Atomic updater for thread-safe modifications to the put pointer.
	 */
	private static final AtomicLongFieldUpdater< ByteRingBuffer > PUT = AtomicLongFieldUpdater.newUpdater( ByteRingBuffer.class, "put" );
	 ...
	 */
	public byte get_multithreaded( byte defaultValueIfEmpty ) {
		long get;
		do {
	 ...
	 * @return The retrieved integer, or defaultValueIfEmpty if the buffer is empty.
	 */
	public byte remove_multithreaded( byte defaultValueIfEmpty ) {
		long currentGet;
		do {
	...
	public boolean put_multithreaded( byte value ) {
		...
		buffer[ ( int ) currentPut & mask ] = ( byte ) value;
		return true;
	}
