...
public class UIntRingBuffer {
	 ...
	 */
	private static final AtomicLongFieldUpdater< UIntRingBuffer > GET = AtomicLongFieldUpdater.newUpdater( UIntRingBuffer.class, "get" );
	
	/**
	 * Atomic updater for thread-safe modifications to the put pointer.
	 */
	private static final AtomicLongFieldUpdater< UIntRingBuffer > PUT = AtomicLongFieldUpdater.newUpdater( UIntRingBuffer.class, "put" );
