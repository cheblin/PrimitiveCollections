...
public class UByteRingBuffer {
	 ...
	 */
	private static final AtomicLongFieldUpdater< UByteRingBuffer > GET = AtomicLongFieldUpdater.newUpdater( UByteRingBuffer.class, "get" );
	
	/**
	 * Atomic updater for thread-safe modifications to the put pointer.
	 */
	private static final AtomicLongFieldUpdater< UByteRingBuffer > PUT = AtomicLongFieldUpdater.newUpdater( UByteRingBuffer.class, "put" );
