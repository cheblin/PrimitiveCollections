 ...
 */
public interface ShortUShortNullMap {
	...
	class RW extends R {
		...
		private int resize( int newSize ) {
			...
			if( isFlatStrategy ) {
				...
				{
					UShortNullList.RW _values = values;
					values = new UShortNullList.RW( newSize );
				...
				values    = new UShortNullList.RW( Math.max( _count * 3 / 2, FLAT_ARRAY_SIZE ) );//_count - optimistic
		 ...
		 */
		private void copy( short[] old_next, short[] old_keys, UShortNullList.RW old_values, int old_count ) {
