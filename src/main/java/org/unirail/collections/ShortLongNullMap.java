 ...
 */
public interface ShortLongNullMap {
	...
	class RW extends R {
		...
		public boolean put(  Short     key,  Long      value ) {
			return key == null ?
					...
					value == null ?
							...
							put( ( short ) ( key + 0 ), ( long ) ( value + 0 ), true );
		}
		 ...
		 * @return {@code true} if the map state was changed (insert or update).
		 */
		public boolean put( short key, long value ) { return put( key, value, true ); }
		
		
		public boolean putNullKey( long  value ) { return put( value, true ); }
		
		public boolean putNullValue( short key ) { return put( key, ( long ) 0, false ); }
		 ...
		 */
		private void copy( short[] old_next, short[] old_keys, LongNullList.RW old_values, int old_count ) {
